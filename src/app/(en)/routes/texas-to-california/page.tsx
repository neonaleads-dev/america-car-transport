...
export const metadata = {
  title: "Texas to California Car Shipping | Cost & Transit | America Car Transport",
  description: "Ship a car from Texas to California — real 2026 pricing, transit times, and FAQs. Zero upfront deposit, fully licensed and bonded. Get an instant quote.",
  alternates: {
    canonical: "https://www.americacartransport.com/routes/texas-to-california",
  },
};

const FAQS = [
  {
    question: "How much does it cost to ship a car from Texas to California?",
    answer: "Shipping a car from Texas to California typically costs between $950 and $1,400 on open transport. Enclosed transport for luxury or classic vehicles runs 30–50% higher ($1,350 to $1,950). Rates vary depending on exact city pairs, vehicle size, and seasonal carrier demand."
  },
  {
    question: "How long does it take to ship a car from Texas to California?",
    answer: "Transit time from Texas to California is typically 3 to 5 days once dispatched. The I-10 and I-40 corridors are among the busiest carrier routes in the nation, ensuring fast pickup and reliable delivery schedules."
  },
  {
    question: "Is it cheaper to ship from Texas to California than other cross-country routes?",
    answer: "Yes. Per mile, the Texas to California corridor offers some of the most competitive auto transport rates in North America due to high carrier availability and balanced two-way freight volume."
  },
  {
...
export default function TexasToCaliforniaRoutePage() {
  const schemaGraph = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://www.americacartransport.com/routes/texas-to-california#webpage",
        "url": "https://www.americacartransport.com/routes/texas-to-california",
        "name": "Texas to California Car Shipping | Cost & Transit Time",
        "description": "Direct auto transport from Texas to California. Real carrier rates, 3-5 day transit, zero deposit.",
        "isPartOf": {
          "@type": "WebSite",
      ...
      {
        "@type": "Service",
        "@id": "https://www.americacartransport.com/routes/texas-to-california#service",
        "serviceType": "Texas to California Car Shipping",
        "name": "Texas to California Car Shipping Service",
        "provider": {
          "@type": "MovingCompany",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.americacartransport.com/routes/texas-to-california#breadcrumb",
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Texas to California", "item": "https://www.americacartransport.com/routes/texas-to-california" }
        ]
      },
      {
        "@type": "FAQPage",
        "@id": "https://www.americacartransport.com/routes/texas-to-california#faq",
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <AnimatedSection direction="up" className="lg:col-span-7">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-blue-50 text-blue-800 rounded-full text-xs md:text-sm font-bold tracking-wide mb-5 border border-blue-200/80 shadow-sm">
              ...
              High-Volume South-to-West Corridor (I-10 / I-40 Highway)
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-[3.8rem] leading-[1.1] font-black text-slate-900 tracking-tight mb-5">
              Texas to California Car Shipping: Cost &amp; Transit Guide
            </h1>

            <p className="text-base md:text-lg text-slate-600 font-medium leading-relaxed max-w-xl mb-6">
              Moving a vehicle from Texas to California? Ship safely across this ~1,400–1,550 mile corridor with bonded carriers, $100K+ cargo insurance, and zero upfront deposit.
            </p>

            {/* Reverse Direction Link */}
            <div className="mb-8">
              <Link href="/routes/california-to-texas" className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-300 rounded-xl text-xs md:text-sm font-extrabold text-blue-700 hover:bg-blue-50 transition-colors shadow-sm">
                <ArrowLeftRight className="w-4 h-4 text-blue-600" />
                Shipping the reverse direction? See California to Texas Car Shipping ➔
              </Link>
            </div>
          ...
          <AnimatedSection direction="up">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight">
                Texas to California Car Shipping Rates by City Pair
              </h2>
            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              <thead>
                <tr className="bg-slate-100 border-b border-slate-200 text-xs font-extrabold text-slate-700 uppercase tracking-wider">
                  <th className="py-4 px-6">Origin (Texas)</th>
              ...
              <tbody className="divide-y divide-slate-200 text-sm font-semibold text-slate-800">
                <tr className="hover:bg-slate-50/80 transition-colors">
                  <td className="py-4 px-6 flex items-center gap-2">
                    <MapPin className="w-4 h-4 text-blue-600" /> Houston, TX
                  </td>
                ...
                <tr className="hover:bg-slate-50/80 transition-colors">
                  <td className="py-4 px-6 flex items-center gap-2">
                    <MapPin className="w-4 h-4 text-blue-600" /> Dallas, TX
                  </td>
                  <td className="py-4 px-6">Los Angeles, CA</td>
                ...
                <tr className="hover:bg-slate-50/80 transition-colors">
                  <td className="py-4 px-6 flex items-center gap-2">
                    <MapPin className="w-4 h-4 text-blue-600" /> San Antonio, TX
                  </td>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
              ...
              <p className="text-xs text-slate-600 font-medium leading-relaxed">
                Over 10,450+ verified customer reviews across Google &amp; BBB. Read real delivery feedback on the TX ➔ CA route.
              </p>
      ...
      <section className="py-16 bg-white border-b border-slate-200">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight">
              Texas to California Shipping FAQs
            </h2>
          </div>
