...
export const metadata = {
  title: "Georgia to New York Car Shipping | Cost & Transit | America Car Transport",
  description: "Ship a car from Georgia to New York — real 2026 pricing, transit times, and FAQs. Zero upfront deposit, fully licensed and bonded. Get an instant quote.",
  alternates: {
    canonical: "https://www.americacartransport.com/routes/georgia-to-new-york",
  },
};

const FAQS = [
  {
    question: "How much does it cost to ship a car from Georgia to New York?",
    answer: "Shipping a car from Georgia to New York typically costs between $600 and $950 for open transport. Enclosed transport runs between $950 and $1,400 depending on exact cities (e.g. Atlanta to NYC vs Savannah to Rochester)."
  },
  {
    question: "How long does transit take between Georgia and New York?",
    answer: "Carriers traveling north along I-85 and I-95 complete Georgia to New York shipments in 2 to 4 days."
  }
];

export default function GeorgiaToNewYorkRoutePage() {
  const schemaGraph = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://www.americacartransport.com/routes/georgia-to-new-york#webpage",
        "url": "https://www.americacartransport.com/routes/georgia-to-new-york",
        "name": "Georgia to New York Car Shipping | Cost & Transit Time",
        "description": "Direct auto transport from Georgia to New York. Real carrier rates, 2-4 day transit, zero deposit.",
      ...
      {
        "@type": "Service",
        "@id": "https://www.americacartransport.com/routes/georgia-to-new-york#service",
        "serviceType": "Georgia to New York Car Shipping",
        "name": "Georgia to New York Auto Transport Service",
        ...
        "areaServed": [{ "@type": "State", "name": "Georgia" }, { "@type": "State", "name": "New York" }],
        "offers": { "@type": "AggregateOffer", "priceCurrency": "USD", "lowPrice": "600", "highPrice": "950" }
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.americacartransport.com/routes/georgia-to-new-york#breadcrumb",
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Georgia to New York", "item": "https://www.americacartransport.com/routes/georgia-to-new-york" }
        ]
      },
      {
        "@type": "FAQPage",
        "@id": "https://www.americacartransport.com/routes/georgia-to-new-york#faq",
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-blue-500/10 text-blue-400 rounded-full text-xs font-bold uppercase tracking-wider mb-4 border border-blue-500/20">
              <Truck className="w-4 h-4 text-blue-400" /> East Coast Corridor (I-85 / I-95 N)
            </div>
            <h1 className="text-3xl md:text-5xl font-black leading-tight text-white mb-4">
              Georgia to New York <span className="text-blue-400">Car Shipping Cost 2026</span>
            </h1>
            <p className="text-slate-300 text-base md:text-lg mb-6 leading-relaxed font-medium">
              Door-to-door auto transport connecting Georgia (Atlanta, Savannah, Augusta, Macon) to New York (NYC, Long Island, Westchester, Buffalo).
            </p>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs md:text-sm">
              <div className="bg-white/5 border border-white/10 p-3 rounded-xl">
                ...
                <div className="text-white font-black text-base">850 – 1,000 miles</div>
              </div>
              <div className="bg-white/5 border border-white/10 p-3 rounded-xl">
              ...
              <div className="bg-white/5 border border-white/10 p-3 rounded-xl col-span-2 sm:col-span-1">
                ...
                <div className="text-blue-400 font-black text-base">$600 – $950</div>
              </div>
            </div>
          </div>
