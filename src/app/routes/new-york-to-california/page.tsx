...
export const metadata = {
  ...
  alternates: {
    canonical: "https://americacartransport.com/routes/new-york-to-california",
  },
};
...
export default function NewYorkToCaliforniaRoutePage() {
  const schemaGraph = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://americacartransport.com/routes/new-york-to-california#webpage",
        "url": "https://americacartransport.com/routes/new-york-to-california",
      ...
      {
        "@type": "Service",
        "@id": "https://americacartransport.com/routes/new-york-to-california#service",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://americacartransport.com/routes/new-york-to-california#breadcrumb",
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "New York to California", "item": "https://americacartransport.com/routes/new-york-to-california" }
        ]
      },
      {
        "@type": "FAQPage",
        "@id": "https://americacartransport.com/routes/new-york-to-california#faq",
