...
const FAQS = [
  {
    question: "How much does it cost to ship a car from California to New York?",
    answer: "Shipping a car from California to New York typically costs between $1,150 and $1,700 on open transport, reflecting this route's status as one of the longest coast-to-coast corridors in the country (~2,800 miles). Enclosed transport for luxury or classic vehicles runs 30–50% higher ($1,650 to $2,400)."
  },
  {
    question: "How long does it take to ship a car from California to New York?",
    answer: "Transit time from California to New York is typically 5 to 7 days once loaded. Carrier transit speed depends on driver hour-of-service regulations, weather conditions, and exact pickup/delivery locations."
  },
  {
    question: "Is it cheaper to drive or ship from California to New York?",
...
export default function CaliforniaToNewYorkRoutePage() {
  const schemaGraph = {
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <AnimatedSection direction="up" className="lg:col-span-7">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[3.8rem] leading-[1.1] font-black text-slate-900 tracking-tight mb-5">
              California to New York Car Shipping: Cost &amp; Transit Guide
            </h1>
            ...
            <div className="mb-8">
              <Link href="/routes/new-york-to-california" className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-300 rounded-xl text-xs md:text-sm font-extrabold text-blue-700 hover:bg-blue-50 transition-colors shadow-sm">
                <ArrowLeftRight className="w-4 h-4 text-blue-600" />
                Shipping the reverse direction? See New York to California Car Shipping ➔
              </Link>
            </div>
          ...
          <AnimatedSection direction="up">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight">
                California to New York Car Shipping Rates by City Pair
              </h2>
            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              <thead>
                <tr className="bg-slate-100 border-b border-slate-200 text-xs font-extrabold text-slate-700 uppercase tracking-wider">
                  ...
                  <th className="py-4 px-6">Destination (New York)</th>
              ...
              <tbody className="divide-y divide-slate-200 text-sm font-semibold text-slate-800">
                <tr className="hover:bg-slate-50/80 transition-colors">
                  ...
                  <td className="py-4 px-6">New York City, NY</td>
                ...
                <tr className="hover:bg-slate-50/80 transition-colors">
                  ...
                  <td className="py-4 px-6">Albany, NY</td>
                ...
                <tr className="hover:bg-slate-50/80 transition-colors">
                  ...
                  <td className="py-4 px-6">Rochester, NY</td>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
              ...
              <p className="text-xs text-slate-600 font-medium leading-relaxed">
                Over 10,450+ verified customer reviews across Google &amp; BBB. Read real delivery feedback on the CA ➔ NY route.
              </p>
      ...
      <section className="py-16 bg-white border-b border-slate-200">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight">
              California to New York Shipping FAQs
            </h2>
          </div>
