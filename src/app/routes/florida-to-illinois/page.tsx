...
export const metadata = {
  title: "Florida to Illinois Car Transport | Cost, Time & Quotes — America Car Transport",
  description: "Ship your car from Florida to Illinois with licensed, insured carriers. Get an instant quote, compare open vs. enclosed rates, and see real transit times.",
  alternates: {
    canonical: "https://www.americacartransport.com/routes/florida-to-illinois",
  },
  openGraph: {
    title: "Florida to Illinois Car Transport | Cost, Time & Quotes — America Car Transport",
    description: "Ship your car from Florida to Illinois with licensed, insured carriers. Get an instant quote, compare open vs. enclosed rates, and see real transit times.",
    url: "https://www.americacartransport.com/routes/florida-to-illinois",
...
const ROUTE_FAQS = [
  {
    q: "How far is it from Florida to Illinois for car transport?",
    a: "Approximately 1,100–1,300 miles depending on your specific origin and destination cities, with a typical 3–5 day transit window."
  },
  {
    q: "How much does it cost to ship a car from Florida to Illinois?",
    a: "Most shipments range from $750 to $1,200 on open transport, with enclosed transport running 40-50% higher depending on vehicle type and season."
  },
  {
    q: "Is it cheaper to drive or ship a car to Illinois?",
    a: "For a one-time move, shipping is often more cost-effective than driving once you factor in gas, tolls, meals, lodging, and 2+ days of your own time."
  },
  {
    q: "Does car shipping from Florida to Illinois include insurance?",
    a: "Yes — every shipment includes cargo insurance in the quoted price, with $100,000 coverage on open carriers and $500,000 on enclosed carriers."
  },
  {
    q: "Can I ship a car from Florida to Chicago specifically?",
    a: "Yes — Chicago is our highest-volume Illinois destination on this corridor, along with its surrounding suburbs (Naperville, Aurora, Joliet, Lake County)."
  },
  {
    q: "Is open transport safe for a car?",
    a: "Yes — open transport is the industry-standard method used for roughly 90% of all vehicle shipments nationwide."
  },
  {
...
export default function FloridaToIllinoisRoutePage() {
  const schema = {
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          {"@type": "ListItem", "position": 3, "name": "Florida to Illinois", "item": "https://www.americacartransport.com/routes/florida-to-illinois"}
        ]
      },
      {
        "@type": "Service",
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "How far is it from Florida to Illinois for car transport?",
            "acceptedAnswer": {"@type": "Answer", "text": "Approximately 1,100–1,300 miles depending on the specific origin and destination cities, with a typical 3–5 day transit window."}
          },
          {
            "@type": "Question",
            "name": "How much does it cost to ship a car from Florida to Illinois?",
            "acceptedAnswer": {"@type": "Answer", "text": "Most shipments range from $750 to $1,200 on open transport, with enclosed transport running 40-50% higher."}
          },
          {
            "@type": "Question",
            "name": "Does car shipping from Florida to Illinois include insurance?",
          ...
          {
            "@type": "Question",
            "name": "Can I ship a car from Florida to Chicago specifically?",
            "acceptedAnswer": {"@type": "Answer", "text": "Yes, Chicago is the highest-volume Illinois destination on this corridor, along with its surrounding suburbs."}
          }
        ]
      }
    ]
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <AnimatedSection direction="up" className="lg:col-span-7">
            <nav className="flex items-center gap-2 text-xs md:text-sm font-semibold text-slate-500 mb-4">
              ...
              <span>/</span>
              <span className="text-slate-900 font-bold">Florida to Illinois</span>
            </nav>
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-blue-50 text-blue-800 rounded-full text-xs md:text-sm font-bold tracking-wide mb-5 border border-blue-200/80 shadow-sm">
              ...
              Midwest Corridor (~1,100–1,300 Miles)
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-[3.6rem] leading-[1.1] font-black text-slate-900 tracking-tight mb-5">
              Florida to Illinois Car Transport
            </h1>

            <p className="text-base md:text-lg text-slate-600 font-medium leading-relaxed max-w-xl mb-8">
              Shipping a car from Florida to Illinois is a well-traveled interstate corridor connecting the Southeast to the Midwest, driven heavily by snowbird returns, relocations, and students heading to or from Illinois schools. Yes, you can ship a car from Florida to Illinois — America Car Transport moves vehicles along this route year-round using licensed, insured carriers, with door-to-door pickup available anywhere in Florida.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 max-w-xl">
              <AnimatedCard delay={0.1}>
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                  ...
                  <div className="text-[11px] text-slate-500 font-semibold mt-1">SE to Midwest</div>
                </div>
              </AnimatedCard>
              ...
              <AnimatedCard delay={0.2}>
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                  ...
                  <div className="text-xl font-black text-blue-600">3–5 Days</div>
              ...
              <AnimatedCard delay={0.3}>
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                  ...
                  <div className="text-xl font-black text-emerald-700">$750+</div>
      ...
      <section className="py-16 bg-white border-b border-slate-200 font-sans">
        <div className="max-w-[1100px] mx-auto px-4 md:px-8 space-y-16">
          ...
          <article className="space-y-6">
            <AnimatedSection direction="up">
              <h2 className="text-3xl font-black text-slate-900 tracking-tight">
                Florida to Illinois Car Shipping Cost &amp; Transit Time
              </h2>
              <p className="text-slate-600 text-sm md:text-base leading-relaxed font-medium mt-2">
                Shipping a car from Florida to Illinois typically costs <strong>$750–$1,200 on open transport</strong> and <strong>$1,100–$1,700 on enclosed transport</strong>, with delivery in 3–5 days.
              </p>
            </AnimatedSection>
                ...
                <table className="w-full text-left text-sm font-medium">
                  ...
                  <tbody className="divide-y divide-slate-200 text-slate-700">
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4 font-extrabold text-blue-600">$750 – $1,200</td>
                      <td className="py-3.5 px-4">3 – 5 days</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Enclosed Carrier</td>
                      <td className="py-3.5 px-4 font-extrabold text-blue-600">$1,100 – $1,700</td>
                      <td className="py-3.5 px-4">3 – 5 days</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4">2 – 3 days</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p className="text-xs text-slate-500 mt-2 font-medium">
                Distance is approximately 1,100–1,300 miles depending on your exact origin and destination. Like other Florida corridors, this route sees higher demand in spring (as snowbirds return north to Illinois) and around fall/spring semester transitions for students. Booking 2–3 weeks ahead of peak windows typically secures better rates. Use our <Link href="/tools/car-shipping-cost-calculator" className="text-blue-600 underline font-bold">Cost Calculator</Link> for a real-time quote based on your specific cities and vehicle.
              </p>
            </AnimatedSection>
          </article>
                ...
                <table className="w-full text-left text-sm font-medium">
                  <thead className="bg-slate-100 text-slate-900 font-black text-xs uppercase border-b border-slate-200">
                    <tr>
                      ...
                      <th className="py-3.5 px-4">Approx. Distance to IL</th>
                  ...
                  <tbody className="divide-y divide-slate-200 text-slate-700">
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4">~1,350 – 1,450 mi</td>
                    ...
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4">~1,320 – 1,420 mi</td>
                      <td className="py-3.5 px-4">Same corridor as Miami</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">West Palm Beach</td>
                      <td className="py-3.5 px-4">~1,270 – 1,370 mi</td>
                      <td className="py-3.5 px-4">Standard South Florida timing</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Fort Myers / Naples</td>
                      <td className="py-3.5 px-4">~1,250 – 1,350 mi</td>
                      <td className="py-3.5 px-4">Southwest FL, similar timing</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Orlando</td>
                      <td className="py-3.5 px-4">~1,100 – 1,200 mi</td>
                    ...
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4">~1,050 – 1,150 mi</td>
                      <td className="py-3.5 px-4">West coast FL, among the shortest FL-side distances</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Jacksonville</td>
                      <td className="py-3.5 px-4">~950 – 1,050 mi</td>
                      <td className="py-3.5 px-4">Northernmost major FL origin — typically the shortest transit time</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <article className="space-y-6">
            <AnimatedSection direction="up">
              <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">
                Popular Illinois Delivery Destinations
              </h2>
            </AnimatedSection>
            ...
            <AnimatedSection direction="up" delay={0.1}>
              <div className="overflow-x-auto border border-slate-200 rounded-2xl shadow-sm">
                <table className="w-full text-left text-sm font-medium">
                  ...
                  <tbody className="divide-y divide-slate-200 text-slate-700">
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Chicago</td>
                      <td className="py-3.5 px-4">Highest-demand IL endpoint; frequent carrier trips, including Naperville, Aurora, Joliet, and Lake County suburbs</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Springfield</td>
                      <td className="py-3.5 px-4">State capital, standard central-IL timing</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Rockford</td>
                      <td className="py-3.5 px-4">Northern IL, similar timing to Chicago-area</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Peoria</td>
                      <td className="py-3.5 px-4">Central IL, standard timing</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Champaign / Bloomington</td>
                      <td className="py-3.5 px-4">East-central IL, standard timing</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <article className="space-y-4">
            <AnimatedSection direction="up">
              ...
              <p className="text-slate-600 text-sm md:text-base leading-relaxed font-medium">
                All standard transport types are available for Florida to Illinois shipments, with door-to-door service included on most quotes at no extra charge.
              </p>
              <ul className="space-y-2.5 text-xs md:text-sm text-slate-700 font-medium mt-4">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span><strong>Open Transport</strong> — the standard, most affordable option, used for the majority of FL-IL shipments (<Link href="/services/open-auto-transport" className="text-blue-600 underline font-bold">Open Transport</Link>)</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span><strong>Expedited Shipping</strong> — priority dispatch for time-sensitive moves</span>
                </li>
              </ul>
            </AnimatedSection>
          </article>
          ...
          <article className="space-y-6">
            <AnimatedSection direction="up">
              <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">
                Shipping Cost by Vehicle Type (Florida to Illinois)
              </h2>
            </AnimatedSection>
                ...
                <table className="w-full text-left text-sm font-medium">
                  ...
                  <tbody className="divide-y divide-slate-200 text-slate-700">
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4">Standard FL-IL pricing above</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                    ...
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">RV</td>
          ...
          <article className="space-y-4">
            <AnimatedSection direction="up">
              ...
              <ul className="space-y-2.5 text-xs md:text-sm text-slate-700 font-medium mt-4">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span><strong>Snowbirds</strong> returning north to Illinois each spring after wintering in Florida</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span><strong>Retirees and relocators</strong> making a permanent move between Florida and Illinois</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span><strong>Students</strong> shipping a vehicle to or from Illinois colleges at semester transitions</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span><strong>Military families</strong> under PCS orders, often needing expedited service</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                  <span><strong>Businesses and dealers</strong> relocating purchased or fleet vehicles between the two states — contact us directly for volume pricing</span>
                </li>
              </ul>
            </AnimatedSection>
          </article>
          ...
          <article className="space-y-4">
            <AnimatedSection direction="up">
              ...
              <ul className="space-y-2.5 text-xs md:text-sm text-slate-700 font-medium mt-4">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                  <span><strong>Vehicle inspection at pickup</strong> — your driver documents your vehicle&apos;s condition before loading.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                  <span><strong>Transit and tracking</strong> — track your shipment throughout the 3–5 day transit window.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                  <span><strong>Delivery and final inspection</strong> — your vehicle is delivered directly to your Illinois address, with a final walk-around inspection against the pickup documentation.</span>
                </li>
              </ul>
              ...
              <ul className="space-y-2.5 text-xs md:text-sm text-slate-700 font-medium mt-4">
                <li className="flex items-start gap-2">
                  ...
                  <span>Up to 100 lbs of personal items are allowed in the trunk or cargo area, secured in a box or bag — not covered by cargo insurance, and hazardous materials, firearms, or illegal items are never permitted.</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertCircle className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
                  <span>Cargo insurance is included on every shipment — $100,000 on open carriers, $500,000 on enclosed carriers — with no separate line-item cost.</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertCircle className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
                  <span>If shipping in winter, note that Midwest weather can occasionally affect delivery scheduling by a day or two; this is communicated proactively if it applies to your shipment.</span>
                </li>
              </ul>
            </AnimatedSection>
          </article>
            ...
            <div className="bg-slate-900 text-white rounded-3xl p-8 md:p-12 shadow-xl">
              <div className="max-w-2xl">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  >
                    Get Instant Florida to Illinois Quote →
                  </Link>
                </div>
              </div>
            </div>
          ...
          <div className="text-center pt-8 border-t border-slate-200 mt-12">
             <p className="text-slate-500 font-medium text-sm">
               Also shipping between California and Illinois? See our <Link href="/routes/california-to-illinois" className="text-blue-600 font-bold hover:underline">California to Illinois</Link> route guide.
             </p>
          </div>
