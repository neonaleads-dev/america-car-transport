...
export const metadata = {
  title: "Florida to New York Car Transport | Cost, Time & Quotes — America Car Transport",
  description: "Ship your car from Florida to New York with licensed, insured carriers. Get an instant quote, compare open vs. enclosed rates, and see real transit times for this popular snowbird route.",
  alternates: {
    canonical: "https://www.americacartransport.com/routes/florida-to-new-york",
  },
  openGraph: {
    title: "Florida to New York Car Transport | Cost, Time & Quotes — America Car Transport",
    description: "Ship your car from Florida to New York with licensed, insured carriers. Get an instant quote, compare open vs. enclosed rates, and see real transit times for this popular snowbird route.",
    url: "https://www.americacartransport.com/routes/florida-to-new-york",
...
const ROUTE_FAQS = [
  {
    q: "How far is it from Florida to New York for car transport?",
    a: "Approximately 1,100–1,300 miles depending on your specific origin and destination cities, with a typical 3–6 day transit window."
  },
  {
    q: "Is it cheaper to drive or ship a car to New York?",
  ...
  {
    q: "Does car shipping from Florida to New York include insurance?",
  ...
  },
  {
    ...
    a: "Yes — spring, as snowbirds head north, is the peak demand window for this route, along with the traditional summer moving season."
  }
];

export default function FloridaToNewYorkRoutePage() {
  const schema = {
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          {"@type": "ListItem", "position": 3, "name": "Florida to New York", "item": "https://www.americacartransport.com/routes/florida-to-new-york"}
        ]
      },
      {
        "@type": "Service",
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "How far is it from Florida to New York for car transport?",
            "acceptedAnswer": {"@type": "Answer", "text": "Approximately 1,100–1,300 miles depending on the specific origin and destination cities, with a typical 3–6 day transit window."}
          },
          {
            "@type": "Question",
            "name": "Is it cheaper to drive or ship a car to New York?",
            "acceptedAnswer": {"@type": "Answer", "text": "For a one-time move, shipping is often more cost-effective than driving once gas, tolls, meals, lodging, and travel time are factored in."}
          },
          {
            "@type": "Question",
            "name": "Does car shipping from Florida to New York include insurance?",
          ...
          {
            "@type": "Question",
            "name": "Is open transport safe for a car?",
            "acceptedAnswer": {"@type": "Answer", "text": "Yes, open transport is the industry-standard method used for roughly 90% of all vehicle shipments nationwide."}
          }
        ]
      }
    ]
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <AnimatedSection direction="up" className="lg:col-span-7">
            <nav className="flex items-center gap-2 text-xs md:text-sm font-semibold text-slate-500 mb-4">
              ...
              <span>/</span>
              <span className="text-slate-900 font-bold">Florida to New York</span>
            </nav>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[3.6rem] leading-[1.1] font-black text-slate-900 tracking-tight mb-5">
              Florida to New York Car Transport
            </h1>

            <p className="text-base md:text-lg text-slate-600 font-medium leading-relaxed max-w-xl mb-8">
              Shipping a car from Florida to New York is the return leg of one of the most heavily traveled snowbird corridors in the country — driven by seasonal residents heading north for the summer, retirees relocating permanently, and students returning to New York schools. Yes, you can ship a car from Florida to New York — America Car Transport moves vehicles along this route year-round using licensed, insured carriers, with door-to-door pickup available anywhere in Florida.
            </p>
      ...
      <section className="py-16 bg-white border-b border-slate-200 font-sans">
        <div className="max-w-[1100px] mx-auto px-4 md:px-8 space-y-16">
          ...
          <article className="space-y-6">
            <AnimatedSection direction="up">
              <h2 className="text-3xl font-black text-slate-900 tracking-tight">
                Florida to New York Car Shipping Cost &amp; Transit Time
              </h2>
              <p className="text-slate-600 text-sm md:text-base leading-relaxed font-medium mt-2">
                Shipping a car from Florida to New York typically costs <strong>$900–$1,400 on open transport</strong> and <strong>$1,300–$2,000 on enclosed transport</strong>, with delivery in 3–6 days.
              </p>
            </AnimatedSection>
            ...
            <AnimatedSection direction="up" delay={0.1}>
              ...
              <p className="text-xs text-slate-500 mt-2 font-medium">
                Distance is approximately 1,100–1,300 miles depending on your exact origin and destination. This is the return leg of the same corridor as our <Link href="/routes/new-york-to-florida" className="text-blue-600 underline font-bold">New York to Florida</Link> route, so the same seasonal pattern applies in reverse — demand and pricing rise in spring (Mar–Apr) as snowbirds head north, and again in fall as students and seasonal movers relocate. Booking 2–3 weeks ahead of peak windows typically secures better rates. Use our <Link href="/tools/car-shipping-cost-calculator" className="text-blue-600 underline font-bold">Cost Calculator</Link> for a real-time quote based on your specific cities and vehicle.
              </p>
            </AnimatedSection>
          </article>
                ...
                <table className="w-full text-left text-sm font-medium">
                  <thead className="bg-slate-100 text-slate-900 font-black text-xs uppercase border-b border-slate-200">
                    <tr>
                      ...
                      <th className="py-3.5 px-4">Approx. Distance to NY</th>
                  ...
                  <tbody className="divide-y divide-slate-200 text-slate-700">
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4">~1,280 – 1,350 mi</td>
                    ...
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4">~1,250 – 1,320 mi</td>
                      <td className="py-3.5 px-4">Same corridor as Miami</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">West Palm Beach</td>
                      <td className="py-3.5 px-4">~1,180 – 1,250 mi</td>
                      <td className="py-3.5 px-4">Popular retiree/snowbird origin</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                    ...
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4">~1,150 – 1,250 mi</td>
                      <td className="py-3.5 px-4">West coast FL, standard timing</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Jacksonville</td>
                      <td className="py-3.5 px-4">~900 – 1,000 mi</td>
                      <td className="py-3.5 px-4">Northernmost major FL origin — typically the shortest transit time to NY</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <article className="space-y-6">
            <AnimatedSection direction="up">
              <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">
                Popular New York Delivery Destinations
              </h2>
            </AnimatedSection>
            ...
            <AnimatedSection direction="up" delay={0.1}>
                ...
                <table className="w-full text-left text-sm font-medium">
                  ...
                  <tbody className="divide-y divide-slate-200 text-slate-700">
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4">Highest carrier availability on this corridor</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Long Island / Brooklyn / Queens</td>
                      <td className="py-3.5 px-4">Often consolidated with NYC-area drop-offs</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      <td className="py-3.5 px-4 font-bold text-slate-900">Buffalo</td>
                      <td className="py-3.5 px-4">Slightly longer transit due to western NY location</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
              ...
              <p className="text-xs text-slate-500 mt-2 font-medium">
                New Jersey deliveries are frequently routed alongside New York shipments given the shared regional carrier network, so if your destination is just across the state line, expect similar pricing and timing.
              </p>
            </AnimatedSection>
          </article>
          ...
          <article className="space-y-4">
            <AnimatedSection direction="up">
              ...
              <p className="text-slate-600 text-sm md:text-base leading-relaxed font-medium">
                All standard transport types are available for Florida to New York shipments, with door-to-door service included on most quotes at no extra charge.
              </p>
              <ul className="space-y-2.5 text-xs md:text-sm text-slate-700 font-medium mt-4">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span><strong>Open Transport</strong> — the standard, most affordable option, used for the majority of FL-NY shipments (<Link href="/services/open-auto-transport" className="text-blue-600 underline font-bold">Open Transport</Link>)</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
          ...
          <article className="space-y-6">
            <AnimatedSection direction="up">
              <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">
                Shipping Cost by Vehicle Type (Florida to New York)
              </h2>
            </AnimatedSection>
                ...
                <table className="w-full text-left text-sm font-medium">
                  ...
                  <tbody className="divide-y divide-slate-200 text-slate-700">
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4">Standard FL-NY pricing above</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
          ...
          <article className="space-y-4">
            <AnimatedSection direction="up">
              ...
              <ul className="space-y-2.5 text-xs md:text-sm text-slate-700 font-medium mt-4">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span><strong>Snowbirds</strong> returning north to New York each spring after wintering in Florida — the highest-volume use case on this route</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span><strong>Retirees and relocators</strong> making a permanent move from Florida back to New York</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span><strong>Students</strong> shipping a vehicle to New York colleges</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Dealers and sellers</strong> relocating a purchased or leased vehicle sight-unseen</span>
                </li>
              </ul>
            </AnimatedSection>
          </article>
          ...
          <article className="space-y-4">
            <AnimatedSection direction="up">
              ...
              <ul className="space-y-2.5 text-xs md:text-sm text-slate-700 font-medium mt-4">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                  <span><strong>Transit and tracking</strong> — track your shipment throughout the 3–6 day transit window.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                  <span><strong>Delivery and final inspection</strong> — your vehicle is delivered directly to your New York address, with a final walk-around inspection against the pickup documentation.</span>
                </li>
              </ul>
              ...
              <ul className="space-y-2.5 text-xs md:text-sm text-slate-700 font-medium mt-4">
                ...
                <li className="flex items-start gap-2">
                  <AlertCircle className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
                  <span>If shipping in winter, note that Northeast weather can occasionally affect delivery scheduling by a day or two; this is communicated proactively if it applies to your shipment.</span>
                </li>
              </ul>
            </AnimatedSection>
          </article>
            ...
            <div className="bg-slate-900 text-white rounded-3xl p-8 md:p-12 shadow-xl">
              <div className="max-w-2xl">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  >
                    Get Instant Florida to New York Quote →
                  </Link>
                </div>
              </div>
            </div>
